...
"""autogenerated by genpy from navigation/sensor_raw_data.msg. Do not edit."""
import sys
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(sensor_raw_data, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.averagePosition is None:
        self.averagePosition = 0
    else:
      self.averagePosition = 0
